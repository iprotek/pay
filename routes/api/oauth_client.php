...
Route::middleware(['oauth.client'])->group(function(){        
    ...
    Route::get('/client-users',[AuthController::class, 'get_users_by_client'])->name('.clients-info');

    Route::get('/client-user/{id}',[AuthController::class, 'get_user_by_client'])->name('.client-info');
